...
# 01-professor
cd ../Professor || exit
mvn -q compile exec:java <../tests/input/01-professor.in >../tests/output/01-professor.out 2>/dev/null
...
# 02-student
cd ../Student || exit
mvn -q compile exec:java -Dexec.args="aluno1000 Cristina Ferreira" <../tests/input/02-student.in >../tests/output/02-student.out 2>/dev/null
...
# 08-admin
cd ../Admin || exit
mvn -q compile exec:java <../tests/input/08-admin.in >../tests/output/08-admin.out 2>/dev/null
